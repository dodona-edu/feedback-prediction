...
class Treeminer:
        ...
        for x, i, scope_list_x in clazz:
            ...
            for y, j, scope_list_y in clazz:
                ...
                if i == j:
                    ...
                    if len(set(x[0] for x in scope_list)) / self.tree_count >= self.support:
    ...
    def get_result(self):
        """
        Return frequent patterns found by analysis
        """
...
if __name__ == '__main__':
    ...
    print(Treeminer([
        {'name': '1', 'children': [{'name': '3', 'children': [{'name': '2', 'children': []}]}, {'name': '3', 'children': [{'name': '1', 'children': []}]}]},
        {'name': '1', 'children': [{'name': '3', 'children': [{'name': '2', 'children': []}]}, {'name': '3', 'children': [{'name': '1', 'children': []}]}]}
    ]).start_analysis().get_result())

    print()

    print(Treeminer([
        {'name': '1', 'children': [{'name': '3', 'children': []}, {'name': '3', 'children': [{'name': '1', 'children': []}, {'name': '2', 'children': []}]}]},
        {'name': '1', 'children': [{'name': '3', 'children': [{'name': '2', 'children': []}]}, {'name': '3', 'children': [{'name': '1', 'children': []}]}]}
    ]).start_analysis().get_result())
